              ...
              {items.map((item) => (
                <div key={item.id} className=\"flex gap-6 p-6 border border-gray-800 bg-chix-gray\">
                  ...
                  <div className=\"flex-1\">
                    ...
                    <p className=\"minimal-text text-gray-300 text-sm mb-4\">
                      {item.description}
                    </p>
          ...
          <div className=\"lg:col-span-1\">
            <div className=\"border border-gray-800 bg-chix-gray p-6 sticky top-32\">
              ...
              <div className=\"space-y-3\">
                <Link 
                  href=\"/checkout\"
                  className=\"block w-full bg-white text-black text-center py-3 minimal-text hover:bg-gray-200 transition-colors\"
                >
                  CHECKOUT
                </Link>
                <Link 
              ...
              <div className=\"mt-6 pt-6 border-t border-gray-700\">
                <h3 className=\"minimal-text text-sm text-gray-400 mb-3\">SECURE CHECKOUT</h3>
                <div className=\"flex gap-2\">
                  <div className=\"flex-1 bg-gray-700 h-8 rounded flex items-center justify-center text-xs\">VISA</div>
                  <div className=\"flex-1 bg-gray-700 h-8 rounded flex items-center justify-center text-xs\">MC</div>
                  <div className=\"flex-1 bg-gray-700 h-8 rounded flex items-center justify-center text-xs\">AMEX</div>
                </div>
              </div>
            </div>
          </div>
